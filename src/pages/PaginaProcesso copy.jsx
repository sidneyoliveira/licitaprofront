    ...
    <div className="overflow-x-auto rounded-lg border border-light-border dark:border-dark-border bg-light-bg-secondary dark:bg-dark-bg-secondary shadow-sm">
        <table className="w-full divide-y divide-light-border dark:divide-dark-border">
            <thead className="bg-gray-100 dark:bg-dark-bg-tertiary">
                <tr>
                    ...
                    <th scope="col" className="py-3 px-4 text-left text-xs font-semibold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary">Item</th>
                    <th scope="col" className="py-3 px-3 text-center text-xs font-semibold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary w-[10%]">Unidade</th>
                    <th scope="col" className="py-3 px-3 text-center text-xs font-semibold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary w-[10%]">Qtd.</th>
                    <th scope="col" className="py-3 px-4 text-center text-xs font-semibold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary w-[15%]">Ações</th>
                </tr>
            </thead>
                ...
                {itens.map((item) => (
                    <React.Fragment key={item.id}>
                        <tr className="hover:bg-light-bg-tertiary dark:hover:bg-dark-bg-tertiary cursor-pointer" onClick={() => onToggleExpand(item.id)}>
                            ...
                            <td className="relative py-4 px-4 text-center text-sm font-medium">
        ...
        {itens.length === 0 && (
            <div className="flex flex-col items-center justify-center p-8 text-center">
                ...
                <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Clique em "Adicionar Item" para começar.</p>
            </div>
        )}
    </div>
);
...
const FornecedorTable = ({ fornecedores, onRemove }) => (
    <div className="overflow-x-auto rounded-lg border border-light-border dark:border-dark-border bg-light-bg-secondary dark:bg-dark-bg-secondary shadow-sm">
        <table className="w-full divide-y divide-light-border dark:divide-dark-border">
            <thead className="bg-gray-100 dark:bg-dark-bg-tertiary">
                <tr>
                    <th scope="col" className="py-3 px-6 text-left text-xs font-semibold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary">Fornecedor</th>
                    <th scope="col" className="py-3 px-3 text-left text-xs font-semibold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary">CNPJ</th>
                    <th scope="col" className="py-3 px-6 text-center text-xs font-semibold uppercase tracking-wider text-light-text-secondary dark:text-dark-text-secondary">Ações</th>
                </tr>
            </thead>
            <tbody className="divide-y divide-light-border dark:divide-dark-border">
                    ...
                    <tr key={forn.id} className="hover:bg-light-bg-tertiary dark:hover:bg-dark-bg-tertiary">
                        <td className="py-4 px-6 text-sm">
                            <div className="flex items-center">
                                <div className="font-medium text-light-text-primary dark:text-dark-text-primary">{forn.razao_social}</div>
                            </div>
                        </td>
                        <td className="px-3 py-4 text-sm text-light-text-secondary dark:text-dark-text-secondary">{forn.cnpj}</td>
                        <td className="relative py-4 px-6 text-center text-sm font-medium">
                            <button onClick={() => onRemove(forn.id)} title="Desvincular" className="text-red-500 hover:text-red-400"><TrashIcon className="w-5 h-5" /></button>
                        </td>
                    </tr>
                ))}
            </tbody>
        ...
        {fornecedores.length === 0 && (
             <div className="flex flex-col items-center justify-center p-8 text-center">
                <BuildingOffice2Icon className="w-12 h-12 text-gray-300 dark:text-gray-600" />
                <p className="mt-4 text-sm font-semibold text-light-text-primary dark:text-dark-text-primary">Nenhum fornecedor vinculado</p>
                <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Clique em "Adicionar Fornecedor" para vincular um.</p>
            </div>
        )}
    </div>
);
