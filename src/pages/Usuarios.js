...
const TableSkeleton = () => (
  <div className="animate-pulse space-y-4">
    {[...Array(5)].map((_, i) => (
      <div
        key={i}
        className="flex items-center space-x-4 py-3 border-b border-gray-100 dark:border-gray-800"
      >
...
const avatarSrc = (u) => {
  ...
  return `https://ui-avatars.com/api/?name=${encodeURIComponent(
    name
  )}&background=0d3977&color=fff&size=128`;
};
